[Cozy][cozy] Telecoop Cozy Connector
=======================================
...
This konnector retrieves your bills from Telecoop.
...
cozy-konnector-telecoop is developed by Romain Clement and distributed under the [AGPL v3 license][agpl-3.0].
